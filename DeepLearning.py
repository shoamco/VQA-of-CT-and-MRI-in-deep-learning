...
dataFeatures = np.concatenate((featuresMri, featuresCt), axis=0, out=None)
y = np.full((len(featuresMri)), 0)
y1 = np.full((len(featuresCt)), 1)
...
# # Fit the model
# model.fit(dataFeatures, Y, epochs=150, batch_size=10,  verbose=2)
# # calculate predictions
# predictions = model.predict(dataFeatures)
# # round predictions
